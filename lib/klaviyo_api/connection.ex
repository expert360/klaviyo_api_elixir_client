...
defmodule KlaviyoAPI.Connection do
  @moduledoc """
  Handle Tesla connections for KlaviyoAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, KlaviyoAPI.Connection,
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - KlaviyoAPI 2024-02-15 - elixir"
        )
      )
