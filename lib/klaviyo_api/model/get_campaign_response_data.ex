...
defmodule KlaviyoAPI.Model.GetCampaignResponseData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :relationships => KlaviyoAPI.Model.GetCampaignResponseDataAllOfRelationships.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:relationships, :struct, KlaviyoAPI.Model.GetCampaignResponseDataAllOfRelationships)
  end
end
