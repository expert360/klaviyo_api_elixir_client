...
defmodule KlaviyoAPI.Model.GetTagResponseCollectionDataInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :relationships => KlaviyoAPI.Model.GetTagResponseCollectionDataInnerAllOfRelationships.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:relationships, :struct, KlaviyoAPI.Model.GetTagResponseCollectionDataInnerAllOfRelationships)
  end
end
