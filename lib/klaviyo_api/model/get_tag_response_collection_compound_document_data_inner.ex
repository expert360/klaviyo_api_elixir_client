...
defmodule KlaviyoAPI.Model.GetTagResponseCollectionCompoundDocumentDataInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :relationships => KlaviyoAPI.Model.GetTagResponseCollectionCompoundDocumentDataInnerAllOfRelationships.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:relationships, :struct, KlaviyoAPI.Model.GetTagResponseCollectionCompoundDocumentDataInnerAllOfRelationships)
  end
end
