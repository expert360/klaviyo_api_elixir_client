...
defmodule KlaviyoAPI.Model.GetFlowMessageResponseCollectionDataInner do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :relationships => KlaviyoAPI.Model.GetFlowMessageResponseCollectionDataInnerAllOfRelationships.t | nil
  }
  ...
  def decode(value) do
    value
     ...
     |> Deserializer.deserialize(:relationships, :struct, KlaviyoAPI.Model.GetFlowMessageResponseCollectionDataInnerAllOfRelationships)
  end
end
