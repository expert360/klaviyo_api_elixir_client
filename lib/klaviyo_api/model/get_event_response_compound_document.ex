...
defmodule KlaviyoAPI.Model.GetEventResponseCompoundDocument do
  @moduledoc """
  ...
  def decode(value) do
    value
     |> Deserializer.deserialize(:data, :struct, KlaviyoAPI.Model.GetEventResponseCollectionCompoundDocumentDataInner)
